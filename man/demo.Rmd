...
knitr::opts_knit$set(root.dir = "~/Library/CloudStorage/OneDrive-UniversityofEdinburgh/Mac/Project/data/MAPseq_analysis")
```
...
# Make sure data_Hans are loaded before running the code below

load("data_Hans.RData")
...
```{r superheat heatmap, fig.width=6,fig.height=6, fig.align='center'}
...
## ----- multiple replicate: compare number of zero counts for each region ------
